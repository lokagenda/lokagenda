...
export function Modal({ open, onClose, title, description, children, className = '' }: ModalProps) {
  ...
  // Portal para document.body: evita que ancestrais com backdrop-filter,
  // transform, filter etc criem containing block e quebrem o fixed inset-0.
  // Ver src/components/ui/portal.tsx.
  return (
    <Portal>
