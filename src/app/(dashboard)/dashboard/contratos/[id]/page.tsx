...
import { updateTemplate } from '@/actions/contracts'
import { replaceVariables, getSampleData } from '@/lib/contract'
...
export default function EditContratoPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const result = await updateTemplate(params.id, formData)
      if (result?.error) {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <h1 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Editar Modelo de Contrato</h1>
        <p className="text-sm text-zinc-500 dark:text-zinc-400">
          Atualize o modelo de contrato com variáveis que serão substituídas automaticamente.
        </p>
      </div>
